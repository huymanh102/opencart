...
class __TwigTemplate_d42e519239d910ada46264202dabbecd74f63b7f53f695fab7422b35a82ea947 extends Twig_Template
{
    private $source;
    ...
    <div class=\"card\">
      ...
      <div class=\"card-body\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
            // line 28
            echo "                  ";
            if ((twig_get_attribute($this->env, $this->source, $context["category"], "value", array()) == ($context["filter_category"] ?? null))) {
                // line 29
                echo "                    <button type=\"button\" class=\"btn btn-outline-secondary dropdown-toggle dropdown-toggle-split\" data-toggle=\"dropdown\">";
                echo ($context["text_category"] ?? null);
                echo " (";
                echo twig_get_attribute($this->env, $this->source, $context["category"], "text", array());
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["license"]) {
            // line 49
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["license"], "value", array()) == ($context["filter_license"] ?? null))) {
                echo "<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["license"], "href", array());
                echo "\" class=\"btn btn-light active\">";
                echo twig_get_attribute($this->env, $this->source, $context["license"], "text", array());
                echo "</a>";
            } else {
                echo "<a href=\"";
                echo twig_get_attribute($this->env, $this->source, $context["license"], "href", array());
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["sorts"]) {
            // line 57
            echo "                  ";
            if ((twig_get_attribute($this->env, $this->source, $context["sorts"], "value", array()) == ($context["sort"] ?? null))) {
                // line 58
                echo "                    <option value=\"";
        ...
        if (($context["promotions"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["extension"]) {
                ...
                if ($context["extension"]) {
                    ...
                    // line 75
                    echo twig_get_attribute($this->env, $this->source, $context["extension"], "href", array());
                    echo "\">
                          <div class=\"extension-description\"></div>
                          <img src=\"";
                    // line 77
                    echo twig_get_attribute($this->env, $this->source, $context["extension"], "image", array());
                    echo "\" alt=\"";
                    ...
                    echo "</a></h4>
                        ";
                    // line 80
                    echo twig_get_attribute($this->env, $this->source, $context["extension"], "price", array());
                    echo "</div>
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                        // line 84
                        echo "                              ";
                        if ((twig_get_attribute($this->env, $this->source, $context["extension"], "rating", array()) >= $context["i"])) {
                    ...
                    // line 87
                    echo twig_get_attribute($this->env, $this->source, $context["extension"], "rating_total", array());
                    echo " ";
...
";
    ...
    {
        return new Twig_Source("", "marketplace/marketplace_list.twig", "/var/www/html/vncrafts.com/admin/view/template/marketplace/marketplace_list.twig");
    }
}
